...
import 'create_feeding_event.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (event.type == DoughEventType.feeding)
                            Text('Ziehzeit: ${(event.payload as Feeding).duration.inHours}h'),
                          Text('Gewicht: ${event.weightModifier.isNegative ? '' : '+'}${event.weightModifier}g'),
                        ],
                      ),
                    ),
            ...
            onSelected: (value) {
              if (value == 0) {
                showDialog<String>(
                  ...
                  builder: (BuildContext context) => AlertDialog(
                    title: const Text('Teig löschen?'),
                    content: Text('Möchtest du den Teig "${dough.name}" und die zugehörigen Events wirklich löschen?'),
                    actions: <Widget>[
